...
def time2Image():
    ...
    geometry = np.load("munnezza/output/scan_00001/scan_00001_geometry.npy")
    snapshots = np.load("munnezza/output/scan_00001/snapshots.npz")["00000_E"]
    ...
    times = np.load("munnezza/output/scan_00001/snapshots.npz")["00000_times"]
